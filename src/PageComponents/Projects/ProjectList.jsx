...
const ProjectList = ({ projList }) => {
    return (
        <div className='flex flex-wrap px-10 pt-5 lg:pt-12 gap-2 lg:gap-4 justify-center w-full'>
            {projList.map((item, index) => (
                <div key={index} className='lg:w-2/7 bg-tabbedAccent h-fit lg:h-65 rounded-2xl flex flex-col items-center py-4 px-4 lg:px-0 relative'>
                    ...
                    <div className='flex flex-wrap gap-2 justify-center pt-2 pb-10 lg:pb-0'>
                        {
